...
class CharacterSkin: Skin {
    ...
    override func draw(in ctx: CGContext) {
        ...
        let bigFont    = UIFont.init(name: "Lato-Light", size: size * 0.5)
        ...
        // Descr
        drawText(label   : textLabel,
                 font    : bigFont!,
                 text    : tile.descr,
                 frame   : CGRect(x: size * 0.05, y: (height - (height - size * 0.255)) * 0.5, width: width - size * 0.1, height: height - size * 0.255),
                 fgdColor: tile.fgdColor,
                 bkgColor: tile.bkgColor,
                 radius  : 0,
                 align   : .center)
