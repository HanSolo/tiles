...
class TextSkin: Skin {
    ...
    override func draw(in ctx: CGContext) {
        ...
        let biggerFont = UIFont.init(name: "Lato-Regular", size: size * 0.1)
        ...
        // Text
        text.font            = biggerFont
        text.textColor       = tile.fgdColor
        text.backgroundColor = tile.backgroundColor
        text.text            = tile.descr
